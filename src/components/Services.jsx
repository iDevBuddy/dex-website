...
export default function Services() {
    ...
    return (
        <section id="services" className="bg-dark py-20 lg:py-28 overflow-hidden">
            ...
            <div ref={track} className="flex gap-6 overflow-x-auto snap-x snap-mandatory scroll-pl-6 pb-8 pt-2 pl-6 pr-6 max-w-[1320px] mx-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                {services.map((s, i) => (
                    <article
                        key={i}
