...
export default function Hero() {
    ...
    return (
        <section className="relative min-h-screen flex items-center bg-dark overflow-hidden pt-24 border-b border-white/5">
            {/* Ambient subtle mouse spotlight - very low opacity */}
            <div
                className="absolute inset-0 pointer-events-none opacity-20 transition-opacity duration-300"
                style={{
                    background: `radial-gradient(800px circle at ${mousePos.x}px ${mousePos.y}px, rgba(0, 82, 255, 0.08), transparent 80%)`,
                }}
            />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 lg:gap-16 items-center w-full py-16">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.03] border border-white/10 mb-8">
                    ...
                    <h1 className="text-4xl sm:text-6xl lg:text-[4.75rem] font-black text-white leading-[0.92] tracking-tighter font-display mb-8">
                    ...
                    <div className="flex flex-wrap gap-4 items-center w-full sm:w-auto">
                        ...
                        <a
                            href="/#pipeline"
                            className="w-full sm:w-auto px-8 py-4 border border-white/8 text-gray-300 font-bold text-xs rounded-xl hover:border-white/15 hover:bg-white/[0.02] hover:text-white text-center transition-all duration-300 hover:scale-[1.02] cursor-pointer"
                        >
                    ...
                    <div className="mt-16 pt-8 border-t border-white/5 flex items-center gap-10 w-full">
                        <div>
                            <p className="font-mono text-2xl font-bold text-white">50+</p>
                            <p className="font-mono text-[0.58rem] tracking-widest uppercase text-gray-500 mt-1">Agents Deployed</p>
                        </div>
                        <div className="w-px h-8 bg-white/10" />
                        <div>
                            <p className="font-mono text-2xl font-bold text-white">24/7</p>
                            <p className="font-mono text-[0.58rem] tracking-widest uppercase text-gray-500 mt-1">Orchestration Uptime</p>
                        </div>
                        <div className="w-px h-8 bg-white/10" />
                        <div>
                            <p className="font-mono text-2xl font-bold text-white">3.8x</p>
                            <p className="font-mono text-[0.58rem] tracking-widest uppercase text-gray-500 mt-1">Average Client ROI</p>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    <div className="relative w-full max-w-[460px] aspect-[4/5] rounded-3xl bg-[#09090B] border border-white/10 p-5 md:p-6 overflow-hidden flex flex-col justify-between shadow-[0_24px_64px_rgba(0,0,0,0.85)]">
                        ...
                        <div className="flex items-center justify-between pb-4 border-b border-white/5">
                            ...
                            <span className="font-mono text-[0.58rem] text-gray-500 uppercase tracking-widest flex items-center gap-1.5">
                        ...
                        <div className="flex-1 py-6 font-mono text-[0.72rem] leading-relaxed text-gray-400 overflow-y-auto flex flex-col gap-2">
                            {consoleState === 'idle' ? (
                                <div className="text-gray-600 flex flex-col gap-1">
                                    <p className="text-white font-bold">$ dex run --agent=all</p>
                                    <p className="mt-2">❯ System status: IDLE</p>
                                    <p>❯ Ready to compile active workflows.</p>
                                    <p className="text-[#0052FF]/60 font-semibold mt-4 text-[0.68rem] animate-pulse">
                                ...
                                <div className="flex flex-col gap-1.5">
                                            ...
                                            <p
                                                ...
                                                className={
                                                    isCmd
                                                        ...
                                                        : isSuccess
                                                        ? 'text-emerald-400 font-bold mt-3'
                                                        : 'text-gray-300'
                                                }
                                            >
                                                {log}
                                    ...
                                    {consoleState === 'compiling' && (
                                        <div className="flex items-center gap-1.5 mt-2">
                                            ...
                                            <span className="text-[#0052FF] text-[10px] animate-pulse">COMPILING STACK...</span>
                                        </div>
                                    )}
                                </div>
                            )}
                        ...
                        <div className="pt-4 border-t border-white/5 flex flex-col gap-3">
                            <div className="flex justify-between items-center text-[0.62rem] font-mono">
                                <span className="text-gray-500 uppercase tracking-widest flex items-center gap-1.5">
                            ...
                            {consoleState !== 'success' ? (
                                <button
                                    ...
                                    className="w-full py-3 bg-[#0052FF] hover:bg-[#0046DB] disabled:opacity-60 text-white font-mono text-[0.68rem] font-bold tracking-wider uppercase rounded-xl flex items-center justify-center gap-2 cursor-pointer transition-colors"
                                >
                                ...
                                <button
                                    ...
                                    className="w-full py-3 bg-white/[0.04] border border-white/8 hover:bg-white/[0.08] text-white font-mono text-[0.68rem] font-bold tracking-wider uppercase rounded-xl flex items-center justify-center gap-2 cursor-pointer transition-colors"
                                >
                                    <RotateCcw size={10} />
